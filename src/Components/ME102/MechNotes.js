...
const MechNotes = () => {
    return (
        <>
            ...
            <Zoom in timeout={2000}>
            <Box className="flex-container" display="flex" flexDirection="row" alignItems="stretch" padding={1} style={{ justifyContent: 'space-around' }}>
            <ImgMediaCard label="Class 16-19" viewUrl="https://docs.google.com/presentation/d/1IUl-MALzv2wuJDsCdaKDHGxmfmxbxptc/edit?usp=sharing&ouid=116176361105568954572&rtpof=true&sd=true" downloadUrl="https://drive.google.com/uc?export=download&id=1IUl-MALzv2wuJDsCdaKDHGxmfmxbxptc" />
            ...
            <ImgMediaCard label="Class 3" viewUrl="https://drive.google.com/file/d/1sLWcFNbHyvJGiAkrJ_vvzOMlEiSs4-g1/view?usp=sharing" downloadUrl="https://drive.google.com/uc?export=download&id=1sLWcFNbHyvJGiAkrJ_vvzOMlEiSs4-g1" />
            <ImgMediaCard label="Class 4" viewUrl="https://drive.google.com/file/d/1eOTEAR_n4jIomVvjL2BWhaXdfNB5S__M/view?usp=sharing" downloadUrl="https://drive.google.com/uc?export=download&id=1eOTEAR_n4jIomVvjL2BWhaXdfNB5S__M" />
            <ImgMediaCard label="Class 5" viewUrl="https://drive.google.com/file/d/1oF8saoPwcfIb6DTytBpUz2Jl8QWsmSZ6/view?usp=sharing" downloadUrl="https://drive.google.com/uc?export=download&id=1oF8saoPwcfIb6DTytBpUz2Jl8QWsmSZ6" />
            </Box>
            </Zoom>
