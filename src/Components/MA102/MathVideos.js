        ...
        <>
            ...
            <Zoom in timeout={2000}>
                <Box className="flex-container" display="flex" flexDirection="row" alignItems="stretch" padding={1} style={{ justifyContent: 'space-around' }}>
                    ...
                    <ImgMediaCard label="Class 13" viewUrl="https://drive.google.com/file/d/1qddEtyDyYB_qilfsb9c0dI6xe10icZro/view?usp=sharing" downloadUrl="https://drive.google.com/uc?export=download&id=1qddEtyDyYB_qilfsb9c0dI6xe10icZro" />
                    <ImgMediaCard label="Class 14" viewUrl="https://drive.google.com/file/d/1TlnHB5_1bTaf3odNoKMyUOp0-8xuXzXd/view?usp=sharing" downloadUrl="https://drive.google.com/uc?export=download&id=1TlnHB5_1bTaf3odNoKMyUOp0-8xuXzXd" />
                    <ImgMediaCard label="Class 15" viewUrl="https://drive.google.com/file/d/1PKtSkoeaKAtFjxtFPydyxKs04gLBYzW8/view?usp=sharing" downloadUrl="https://drive.google.com/uc?export=download&id=1PKtSkoeaKAtFjxtFPydyxKs04gLBYzW8" />
                </Box>
            </Zoom>
