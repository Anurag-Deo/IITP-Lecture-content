        ...
        <>
            ...
            <Zoom in timeout={2000}>
                <Box className="flex-container" display="flex" flexDirection="row" alignItems="stretch" padding={1} style={{ justifyContent: 'space-around' }}>
                    <ImgMediaCard label="Class 1" viewUrl="https://drive.google.com/file/d/1HhbNxYkCJPc0ciG5DLWjOq2_baupQii4/view?usp=drivesdk" downloadUrl="https://drive.google.com/uc?export=download&id=1HhbNxYkCJPc0ciG5DLWjOq2_baupQii4" />
                    <ImgMediaCard label="Class 2" viewUrl="https://drive.google.com/file/d/1cbbDtWCV0XznQd986wpXxiks5l1ISYMv/view?usp=drivesdk" downloadUrl="https://drive.google.com/uc?export=download&id=1cbbDtWCV0XznQd986wpXxiks5l1ISYMv" />
                    <ImgMediaCard label="Class 3" viewUrl="https://drive.google.com/file/d/16V1cM1r8qT8p9gC2xDlrWWn3qLx5E7dF/view?usp=drivesdk" downloadUrl="https://drive.google.com/uc?export=download&id=16V1cM1r8qT8p9gC2xDlrWWn3qLx5E7dF" />
                    <ImgMediaCard label="Class 3" viewUrl="https://drive.google.com/file/d/1OrRmKOYvJXVInYyE985SqLCiAZ-Nygdb/view?usp=drivesdk" downloadUrl="https://drive.google.com/uc?export=download&id=1OrRmKOYvJXVInYyE985SqLCiAZ-Nygdb" />
                    <ImgMediaCard label="Class 4" viewUrl="https://drive.google.com/file/d/1q6Y5gJkjt2iF1nSV2wxVfdnXAAkmj1cu/view?usp=drivesdk" downloadUrl="https://drive.google.com/uc?export=download&id=1q6Y5gJkjt2iF1nSV2wxVfdnXAAkmj1cu" />
                </Box>
            </Zoom>
            {/* </Fade> */}
            {/* <Fade in timeout={3000}> */}
            <Zoom in timeout={2000}>
                <Box className="flex-container" display="flex" flexDirection="row" alignItems="stretch" padding={1} style={{ justifyContent: 'space-around' }}>
                    <ImgMediaCard label="Class 5" viewUrl="https://drive.google.com/file/d/1XJMcqWLoL1eoP3wUPaQp6fJF35JmzVId/view?usp=drivesdk" downloadUrl="https://drive.google.com/uc?export=download&id=1XJMcqWLoL1eoP3wUPaQp6fJF35JmzVId" />
                    <ImgMediaCard label="Class 6" viewUrl="https://drive.google.com/file/d/17kicd5sYrz4wOcT5FQy3KFaOztsWhVPs/view?usp=drivesdk" downloadUrl="https://drive.google.com/uc?export=download&id=17kicd5sYrz4wOcT5FQy3KFaOztsWhVPs" />
                    <ImgMediaCard label="Class 6" viewUrl="https://drive.google.com/file/d/1POG8tlNYKOTL-TjalOsvISKYBL4lnqQf/view?usp=drivesdk" downloadUrl="https://drive.google.com/uc?export=download&id=1POG8tlNYKOTL-TjalOsvISKYBL4lnqQf" />
                    <ImgMediaCard label="Class 7" viewUrl="https://drive.google.com/file/d/1eFIihSJY0fpsRL1UAN8lkSTBbsnptILw/view?usp=drivesdk" downloadUrl="https://drive.google.com/uc?export=download&id=1eFIihSJY0fpsRL1UAN8lkSTBbsnptILw" />
                    <ImgMediaCard label="Class 8" viewUrl="https://drive.google.com/file/d/1XPglCA0IPpg7rK8vKnKHLmJ-pr_HZQCi/view?usp=drivesdk" downloadUrl="https://drive.google.com/uc?export=download&id=1XPglCA0IPpg7rK8vKnKHLmJ-pr_HZQCi" />
                </Box>
            </Zoom>
            {/* </Fade> */}
            ...
            <Zoom in timeout={2000}>
                <Box className="flex-container" display="flex" flexDirection="row" alignItems="stretch" padding={1} style={{ justifyContent: 'space-around' }}>
                    <ImgMediaCard label="Class 9" viewUrl="https://drive.google.com/file/d/1ZPVEZF-nJA4zWobJgP7XKVUAaYAJgD1X/view?usp=drivesdk" downloadUrl="https://drive.google.com/uc?export=download&id=1ZPVEZF-nJA4zWobJgP7XKVUAaYAJgD1X" />
                    <ImgMediaCard label="Class 10" viewUrl="https://drive.google.com/file/d/1TrCBYCm8OW1Io-xIXvclrwQ8VtUXarGp/view?usp=drivesdk" downloadUrl="https://drive.google.com/uc?export=download&id=1TrCBYCm8OW1Io-xIXvclrwQ8VtUXarGp" />
            ...
            <Zoom in timeout={2000}>
                <Box className="flex-container" display="flex" flexDirection="row" alignItems="stretch" padding={1} style={{ justifyContent: 'space-around' }}>
                    ...
                    <ImgMediaCard label="Class 7" viewUrl="https://drive.google.com/file/d/1cWqcwptyfpXW4dy32JM4x88Scc-3hGOY/view?usp=sharing" downloadUrl="https://drive.google.com/uc?export=download&id=1cWqcwptyfpXW4dy32JM4x88Scc-3hGOY" />
                </Box>
            </Zoom>
        </>
    )
