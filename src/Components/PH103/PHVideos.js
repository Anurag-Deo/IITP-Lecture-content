...
const PHVideos = () => {
    return (
        <>
            ...
            <Zoom in timeout={2000}>
                <Box className="flex-container" display="flex" flexDirection="row" alignItems="stretch" padding={1} style={{ justifyContent: 'space-around' }}>
                    <ImgMediaCard content="Download the video mannualy" label="Class 15" viewUrl="https://video.wixstatic.com/video/f31d29_020c967d54d845d8ad73664d91640d1e/1080p/mp4/file.mp4" />
                    <ImgMediaCard content="Download the video mannualy" label="Class 16" viewUrl="https://video.wixstatic.com/video/f31d29_a6e95217cc8b4806b714b25b2b1f5c90/1080p/mp4/file.mp4" />
                </Box>
            </Zoom>
